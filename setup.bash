...
- Placeholder files for papers, figures, slides" || echo "Nothing to commit or commit failed"
...
gh label create "session-1" --repo "$REPO_NAME" --color "0E8A16" --description "Session 1 materials" 2>/dev/null || true
gh label create "speaker-needed" --repo "$REPO_NAME" --color "D93F0B" --description "Need to recruit speaker" 2>/dev/null || true
gh label create "logistics" --repo "$REPO_NAME" --color "0052CC" --description "Series logistics and organization" 2>/dev/null || true
gh label create "high-priority" --repo "$REPO_NAME" --color "B60205" --description "High priority item" 2>/dev/null || true
